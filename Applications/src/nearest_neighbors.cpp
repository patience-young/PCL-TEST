...
/** \brief Loads an n-D histogram file as a VFH signature
  ...
  */
bool
loadHist (const std::string &path, vfh_model &vfh)
{
  int vfh_idx;
  ...
  try
  {
    ...
    r.readHeader (path.c_str(), cloud, origin, orientation, version, type, idx);
  ...
  pcl::io::loadPCDFile (path.c_str(), point);
